...
assert.match(checkoutSource, /Current approved public operator disclosure/i);
...
assert.match(checkoutSource, /Public payment remains disabled until the complete disclosure bundle is configured, reviewed, and separately approved for Live use/i);
