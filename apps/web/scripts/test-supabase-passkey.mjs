...
assert.match(passkeyPage, /op=registration-options/);
assert.match(passkeyPage, /op=registration-verify/);
assert.match(passkeyPage, /op=rename/);
assert.match(passkeyPage, /op=delete/);
