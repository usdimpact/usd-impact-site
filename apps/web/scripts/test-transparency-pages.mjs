...
assert.match(threeDialsWorkflow, /pull_request.*validate-and-build.*Dependency review/);
...
assert.match(threeDialsWorkflow, /Generated Three-Dials PR body lost required literal/);
