---
title: "The Dollar Transmission Chain"
metaTitle: "Dollar Transmission Chain | USD Impact Framework"
metaDescription: "A practical educational framework for tracing how policy, rates, funding and liquidity can transmit through the dollar into cross-asset markets."
slug: "/framework/dollar-transmission-chain"
category: "Framework"
status: "published"
readingLevel: "Beginner to intermediate"
lastReviewed: "2026-08-25"
complianceNote: "Educational only. Not investment, legal, tax, trading, or financial advice. Not a recommendation, forecast, or trading signal. Transmission paths are conditional, can run in both directions, and may be dominated by asset-specific shocks."
sources:
  - "Federal Reserve — monetary policy, balance sheet and financial-stability materials"
  - "Federal Reserve Bank of St. Louis FRED — Treasury yields, real yields and financial-condition series"
  - "U.S. Department of the Treasury — Treasury market and debt-management information"
  - "Bank for International Settlements — global dollar funding and cross-border finance research"
internalLinks:
  - "/start-here"
  - "/dollar-framework"
...
hero: "The dollar is not just a price. It is part of a transmission system connecting policy, rates, funding, liquidity, risk appetite and asset prices."
subhero: ""
...
- inflation or labor-market data changing expectations for monetary policy;
- Federal Reserve decisions, guidance or balance-sheet changes;
- Treasury issuance or settlement affecting market liquidity and term premium;
- an energy shock affecting inflation expectations and growth assumptions;
- a banking or funding event changing demand for cash and high-quality collateral.
...
- Is DXY rising, falling or rangebound?
- Is a broad dollar index moving in the same direction?
...
- volatility measures;
- signs of funding-market strain;
- central-bank liquidity operations;
- balance-sheet and reserve conditions;
- cross-currency funding measures where available.
...
- make the proposed mechanism explicit;
- identify what evidence would confirm it;
- identify what evidence would contradict it;
- distinguish broad macro transmission from an asset-specific move;
- revisit the explanation when new data arrive.
...
Next: turn this reasoning into a repeatable weekly process with the **[Three-Dial Macro Dashboard](/framework/three-dial-dashboard/)**.
