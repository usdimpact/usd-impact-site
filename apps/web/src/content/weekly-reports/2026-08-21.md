...
The completed-Friday score moved further into a soft-dollar regime. That systematic result did not depend on a single news claim: it reflected the combined configuration of eight standardized market inputs at the end of the completed week. The daily editions provide the verified event context and conditional transmission channels; the score archive provides the deterministic cross-asset measurement.
