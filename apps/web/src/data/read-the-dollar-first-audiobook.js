export const AUDIOBOOK_BASE_URL = 'https://n0w53ba4ottrav2w.public.blob.vercel-storage.com/read-the-dollar-first';
...
export const readTheDollarFirstAudiobook = {
  ...
  coverUrl: `${AUDIOBOOK_BASE_URL}/cover.jpg`,
  coverAlt: 'Dark navy audiobook cover for Read the Dollar First, with gold-and-silver market-transmission waves above a half-globe.',
  chapters: [
  ...
  ].map(([title, file, duration], index) => ({
    index,
    title,
    duration,
    url: `${AUDIOBOOK_BASE_URL}/${file}`,
  })),
};
