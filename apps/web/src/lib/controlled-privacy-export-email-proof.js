...
const PROOF_TOKEN_SHA256 = '9f287d838ca890d539f9658d2b92ed2f282d88fa3eb77cecd1a491bc01d0e004';
const PROOF_EXPIRES_AT = Date.parse('2026-08-20T22:00:00.000Z');
const FIXTURE_ACCOUNT_ID = '01953304-1b4a-4fea-87ee-fb46a40b02d7';
const FIXTURE_EMAIL = 'delivered+issue130-privacy-export-20260820@resend.dev';
const FIXTURE_GENERATED_AT = '2026-08-20T19:50:00.000Z';
...
function exportResultFixture() {
  return Object.freeze({
    ...
    data: Object.freeze({
      privateProofMarker: 'PRIVATE_EXPORT_PAYLOAD_MUST_NOT_ENTER_EMAIL',
    }),
  });
}

function verifiedUserFixture() {
  return Object.freeze({
...
export async function handleControlledPrivacyExportEmailProof(request, response) {
  ...
  if (
    ...
    || keys[0] !== 'action'
    || keys[1] !== 'proof'
    || url.searchParams.get('action') !== 'controlled-privacy-export-email-proof'
  ...
  try {
    ...
    const state = await enqueuePrivacyExportAcknowledgementEmail({
      exportResult: exportResultFixture(),
    ...
    console.error('Controlled privacy-export email proof failed.', { code });
