...
| P0 | Improve the existing access-ready welcome email | Implemented, not sent | Existing transactional event only; template version `2026-09-02.v2`; no new campaign or dispatch |
...
- **Email:** only copy for the existing purchase-access-ready transaction changes. No email is dispatched as part of development or QA.
